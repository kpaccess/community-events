      ...
      <Container maxWidth="sm">
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 3, alignItems: 'center' }}>
          ...
          <Box sx={{ display: { xs: 'none', md: 'block' } }}>
            ...
            <Typography variant="h4" fontWeight={800} sx={{ mb: 1, fontFamily: '"Syne", sans-serif' }}>
              Join Gather
            </Typography>
            <Typography color="text.secondary" sx={{ mb: 3, lineHeight: 1.7 }}>
              Your local community events hub. Free forever.
            </Typography>
          ...
          <Paper sx={{ p: { xs: 3, sm: 4 }, borderRadius: 3 }} elevation={0}>
            <Typography variant="h6" fontWeight={700} mb={0.5} display={{ xs: 'block', md: 'none' }}>
              Create your account
            </Typography>
            <Typography color="text.secondary" fontSize="0.9rem" mb={2.5} display={{ xs: 'block', md: 'none' }}>
              Join the community today
            </Typography>
            <Typography variant="h6" fontWeight={700} mb={2.5} display={{ xs: 'none', md: 'block' }}>
              Create account
            </Typography>
            ...
            <Typography textAlign="center" fontSize="0.9rem" color="text.secondary">
              ...
              <Box component={Link} href="/auth/login" sx={{ color: 'primary.main', fontWeight: 700, textDecoration: 'none' }}>
                Sign in
              </Box>
            </Typography>
          </Paper>
